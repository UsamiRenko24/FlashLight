...
import com.cbin.phone.cleaner.integration.toaster.config.IToast;
import com.cbin.phone.cleaner.integration.toaster.config.IToastStrategy;
import com.cbin.phone.cleaner.integration.toaster.config.IToastStyle;
...
public class ToastStrategy implements IToastStrategy {
    ...
    public IToast createToast(ToastParams params) {
        ...
        IToast toast;
        if (VERSION.SDK_INT >= VERSION_CODES.M && Settings.canDrawOverlays(mApplication)) {
        ...
        } else if (VERSION.SDK_INT < VERSION_CODES.Q && !areNotificationsEnabled(mApplication)) {
    ...
    protected boolean isChangeEnabledCompat(long changeId) {
        ...
        try {
            ...
            Class<?> clazz = Class.forName(ToastConstants.CLS_COMPAT_CHANGES);
            Method method = clazz.getMethod(ToastConstants.IS_CHANGE_ENABLED, long.class);
    ...
    protected boolean areNotificationsEnabled(Context context) {
        ...
        if (VERSION.SDK_INT >= VERSION_CODES.KITKAT) {
            ...
            try {
                Method method = appOps.getClass().getMethod(ToastConstants.CHECK_OP_NO_THROW,
                        Integer.TYPE, Integer.TYPE, String.class);
                Field field = appOps.getClass().getDeclaredField(ToastConstants.OP_POST_NOTIFICATION);
